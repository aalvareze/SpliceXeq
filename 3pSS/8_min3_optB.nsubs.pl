...
while (<FILE1>){
	...
	while (<FILE2>){
		...
		$PATH_PRINT_PRE="/path/to/" . "$REQUEST" . "/" . "acceptor.splice.sites/nucleotide.substitutions" . "/" . "$NAME" . "." . "$POS" . "." . "$OBS" . "/" . "reads.cryptic.splicing.v5.nodup.min3_optB_PRE.txt";
		...
		close FILE_PRINT;
		$PATH_PRINT="/path/to/" . "$REQUEST" . "/" . "acceptor.splice.sites/nucleotide.substitutions" . "/" . "$NAME" . "." . "$POS" . "." . "$OBS" . "/" . "reads.cryptic.splicing.v5.nodup.min3_optB.txt";
