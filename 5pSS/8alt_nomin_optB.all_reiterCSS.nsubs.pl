...
while (<FILE2>){
	...
	while (<FILE3>){
		...
		$PATH_PRINT_PRE="/path/to/" . "$REQUEST" . "/" . "donor.splice.sites/nucleotide.substitutions" . "/" . "$NAME" . "." . "$POS" . "." . "$OBS" . "/" . "reads.cryptic.splicing.v5.nodup.nomin_optB_PRE.txt";
		...
		$PATH_PRINT="/path/to/" . "$REQUEST" . "/" . "donor.splice.sites/nucleotide.substitutions" . "/" . "$NAME" . "." . "$POS" . "." . "$OBS" . "/" . "reads.cryptic.splicing.v5.nodup.nomin_optB.txt";
